...
```{r}
clever.Dat1.PCATF = clever(Dat1, trend_filtering=TRUE)
clever.Dat2.PCATF = clever(Dat2, trend_filtering=TRUE)

grid.arrange(grobs=list(D1=plot(clever.Dat1.PCATF)+ggtitle('Dat1'), 
                        D2=plot(clever.Dat2.PCATF)+ggtitle('Dat2')), ncol=2)
```

### Image reconstruction

We can reconstruct the original fMRI images with the mask used for vectorizing.
