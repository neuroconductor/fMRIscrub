...
plot(clever.Dat1.var.lev, title="Dat1", show.legend=FALSE)
```

```{r fig.width=4, fig.height=3}
plot(clever.Dat2.var.lev, title="Dat2", show.legend=FALSE)
```
...
```{r}
clever.Dat1 = clever(Dat1, verbose=TRUE, measures="all")
clever.Dat2 = clever(Dat2, verbose=TRUE, measures="all")
```
