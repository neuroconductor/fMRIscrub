...
```{r}
clever.Dat1.PCATF.lev = clever(Dat1, PCA_trend_filtering=TRUE)
#clever.Dat1.PCATF.rbd = clever(Dat1, PCA_trend_filtering=TRUE, 
#                               method='robdist')
#clever.Dat1.PCATF.rbs = clever(Dat1, PCA_trend_filtering=TRUE, 
#                               method='robdist_subset')
clever.Dat2.PCATF.lev = clever(Dat2, PCA_trend_filtering=TRUE)
#clever.Dat2.PCATF.rbd = clever(Dat2, PCA_trend_filtering=TRUE, 
#                               method='robdist')
#clever.Dat2.PCATF.rbs = clever(Dat2, PCA_trend_filtering=TRUE, 
#                               method='robdist_subset')
```

```{r fig.height=4, fig.width=7}
grid.arrange(grobs=list(
  D1=plot(clever.Dat1.PCATF.lev)+ggtitle('Dat1, PCATF'), 
  D2=plot(clever.Dat2.PCATF.lev)+ggtitle('Dat2, PCATF')), ncol=2)
```
...
image(Lev_Img1.mean[,,,1], main=paste0('Lev. img., mean dir. (T=60)'))
image(Lev_Img1.top[,,,1], main=paste0('Lev. img., top dir. (T=60)'))
```