...
Mask2 = readNIfTI('../data/Dat2_mask.nii.gz')
Img2 = Matrix_to_VolumeTimeSeries(Dat2, Mask2)
```

Below, we compare the timepoint of median leverage (first) to the timepoint of maximum leverage (second). We choose to use the mean and leverage parameter settings.
