...
3. Measure leverage across the $K$ components. If $C$ is the matrix of selected components, then leverage is the diagonal of the hat matrix $C(C'C)^{-1}C'$. The $T$ leverage values are interpreted as a measure of outlyingness at each timepoint. Note that if the components are orthogonal as in PCA, then leverage simplifies to the sum of squared component values at each timepoint.
