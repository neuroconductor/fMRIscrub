...
```{r}
Dat1.lev = pscrub(Dat1, verbose=TRUE, comps_mean_dt=1, comps_var_dt=1)
# same as: scrub(Dat1, verbose=TRUE, comps_mean_dt=1, comps_var_dt=1)
Dat2.lev = pscrub(Dat2, verbose=TRUE, comps_mean_dt=1, comps_var_dt=1)
```
