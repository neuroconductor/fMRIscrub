...
#  the default (ICA + kurtosis), PCATF + kurtosis, and ICA
Dat1.lev3 <- fMRIscrub:::clever_multi(
  Dat1, projection=c("ICA_kurt", "PCATF_kurt", "ICA"), verbose=TRUE, comps_mean_dt=1, comps_var_dt=1
)
fMRIscrub:::plot.clever_multi(Dat1.lev3, legend.position="bottom") # Doesn't work yet!
```
