...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/mandymejia/fMRIscrub.svg?branch=master)](https://travis-ci.com/github/mandymejia/fMRIscrub)
...
Two scans from the [ABIDE I](http://fcon_1000.projects.nitrc.org/indi/abide/abide_I.html) are included in `fMRIscrub`: `Dat1` has many artifacts whereas `Dat2` is relatively artifact-free. Both are vectorized sagittal slices stored as numeric matrices. They are loaded into the environment upon loading the package.
