...
#' of Robust Distances.
#'
#' @param Q number of variables in dataset used to compute MCD distances
#' @param n total number of observations
#' @param h number of observations included in estimation of MCD center and scale
#'
#' @return
#' @export
#'
